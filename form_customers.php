	...
	<div class="container">
		...
		<div class="row myform">
			<div class="col-md-7 col-md-offset-3">
				...
				<form name="form_incidencies" action="update_customers.php?operacio=<?=$operacio?>" role="form" method="post">
					<div class="form-group">
						<label class="control-label" for="id_customer">Número d'incidència:</label>
						<input required type="number" name="id_customer" id="id_customer" min="1" max="10000" class="form-control" placeholder="Introdueix el número d'incidència" value="<?=$row["id_customer"]?>"<?php if ($operacio=="edit") echo "readonly" ?>/>
					</div>
                    <div class="form-group">
					...
					<div class="form-group">
						...
						<input required type="text" name="phonenumber" id="phonenumber" maxlength="25" class="form-control" placeholder="Insert phone-number" value="<?php if (isset($row)) echo $row["phonenumber"]?>"/>
					</div>
                    <br>
					<div class="form-inline">
						...
						<div class="form-group">
							...
							<input required type="text" name="address" id="address" maxlength="50" class="form-control" placeholder="Insert address" value="<?php if (isset($row)) echo $row["address"]?>"/>
						</div>
					</div>
                    <br>
